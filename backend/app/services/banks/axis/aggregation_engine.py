"""Phase 4: axis aggregation wraps shared pipeline.aggregation."""
...
class AxisAggregationResult:
    ...
    @classmethod
    def from_shared(cls, shared: SharedAggregationResult) -> "AxisAggregationResult":
        return cls(
...
class AxisAggregationEngine:
    ...
    def aggregate(
        ...
        return AxisAggregationResult.from_shared(shared)
