"""Phase 3: axis reconciliation wraps shared pipeline.reconciliation."""
...
class AxisReconciliationResult:
    ...
    @classmethod
    def from_shared(cls, shared: SharedReconciliationResult) -> "AxisReconciliationResult":
        return cls(
...
class AxisReconciliation:
    ...
    def reconcile(
        ...
        result = AxisReconciliationResult.from_shared(shared)
        self.logger.info(
