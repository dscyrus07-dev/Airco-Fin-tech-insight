"""Phase 4: bank_of_baroda aggregation wraps shared pipeline.aggregation."""
...
@dataclass
class BankOfBarodaAggregationResult:
    ...
    @classmethod
    def from_shared(cls, shared: SharedAggregationResult) -> "BankOfBarodaAggregationResult":
        return cls(
...
class BankOfBarodaAggregationEngine:
    ...
    ) -> BankOfBarodaAggregationResult:
        shared = self._engine.aggregate(
            transactions,
            opening_balance=opening_balance,
            closing_balance=closing_balance,
        )
        return BankOfBarodaAggregationResult.from_shared(shared)
