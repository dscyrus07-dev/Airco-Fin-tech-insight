"""Phase 3: bank_of_baroda reconciliation wraps shared pipeline.reconciliation."""
...
class BankOfBarodaReconciliationResult:
    ...
    @classmethod
    def from_shared(cls, shared: SharedReconciliationResult) -> "BankOfBarodaReconciliationResult":
        return cls(
...
class BankOfBarodaReconciliation:
    ...
    def reconcile(
    ...
    ) -> BankOfBarodaReconciliationResult:
        if not transactions:
            raise BankOfBarodaReconciliationError(
        ...
        result = BankOfBarodaReconciliationResult.from_shared(shared)
        self.logger.info(
