"""Phase 4: hdfc aggregation wraps shared pipeline.aggregation."""
...
class HDFCAggregationResult:
    ...
    @classmethod
    def from_shared(cls, shared: SharedAggregationResult) -> "HDFCAggregationResult":
        return cls(
...
class HDFCAggregationEngine:
    ...
    def aggregate(
        ...
        return HDFCAggregationResult.from_shared(shared)
