"""Phase 4: icici aggregation wraps shared pipeline.aggregation."""
...
class ICICIAggregationResult:
    ...
    @classmethod
    def from_shared(cls, shared: SharedAggregationResult) -> "ICICIAggregationResult":
        return cls(
...
class ICICIAggregationEngine:
    ...
    def aggregate(
        ...
        return ICICIAggregationResult.from_shared(shared)
