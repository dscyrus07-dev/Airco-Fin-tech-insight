"""Phase 4: kotak aggregation wraps shared pipeline.aggregation."""
...
class KotakAggregationResult:
    ...
    @classmethod
    def from_shared(cls, shared: SharedAggregationResult) -> "KotakAggregationResult":
        return cls(
...
class KotakAggregationEngine:
    ...
    ) -> KotakAggregationResult:
        shared = self._engine.aggregate(
            transactions,
            opening_balance=opening_balance,
            closing_balance=closing_balance,
        )
        return KotakAggregationResult.from_shared(shared)
