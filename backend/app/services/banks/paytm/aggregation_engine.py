"""Phase 4: paytm aggregation wraps shared pipeline.aggregation."""
...
class PaytmAggregationResult:
    ...
    @classmethod
    def from_shared(cls, shared: SharedAggregationResult) -> "PaytmAggregationResult":
        return cls(
...
class PaytmAggregationEngine:
    ...
    ) -> PaytmAggregationResult:
        shared = self._engine.aggregate(
            transactions,
            opening_balance=opening_balance,
            closing_balance=closing_balance,
        )
        return PaytmAggregationResult.from_shared(shared)
