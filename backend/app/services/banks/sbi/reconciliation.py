"""Phase 3: sbi reconciliation wraps shared pipeline.reconciliation."""
...
class SBIReconciliationResult:
    ...
    @classmethod
    def from_shared(cls, shared: SharedReconciliationResult) -> "SBIReconciliationResult":
        return cls(
...
class SBIReconciliation:
    ...
    def reconcile(
        ...
        result = SBIReconciliationResult.from_shared(shared)
        self.logger.info(
